class TelaEmprestimo():
  ...
  def mostra_emprestimo(self, dados_emprestimo):
    ...
    print("TITULO DO LIVRO: ", dados_emprestimo["titulo_banda"])
    print("CODIGO DO LIVRO: ", dados_emprestimo["codigo_banda"])
    print("NOME DO AMIGO: ", dados_emprestimo["nome_banda"])
    print("CPF DO AMIGO: ", dados_emprestimo["cpf_banda"])
    print("\n")
